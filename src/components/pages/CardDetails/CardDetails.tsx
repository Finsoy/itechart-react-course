    ...
    return (
        <div>
            ...
            <div className={classes.container}>
                ...
                <MyCard headerText={card.title} bodyText={card.body} id={card.id} isEdit={editAndSaveState.isEdit}
                        isSave={editAndSaveState.isSave}/>
                {editAndSaveState.isEdit &&
                <Button className={classes.btn} variant="contained" color="secondary" onClick={setIsSave}
                >
                    Cancel
                </Button>}
                {editAndSaveState.isEdit &&
                <Button className={classes.btn} variant="contained" color="primary" onClick={setIsEdit}
                >
                    Save
                </Button>}
                {!editAndSaveState.isEdit &&
                <Button className={classes.btn} variant="contained" color="primary" onClick={setIsSave}
                >
                    Change
                </Button>}
            </div>
